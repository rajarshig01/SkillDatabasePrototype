sap.ui.jsview("skilldatabaseprototype.SkillDatabasePrototype", {
	...
	createContent : function(oController) {
		...
		oTechnicalModel.setData({
			modelData : TechnicalData
		});
		...
		var oButtonAddSkill = new sap.ui.commons.Button({
			...
			press : function() {
				oToolPopUpSkillCatalog.setPosition(
						sap.ui.core.Popup.Dock.LeftTop,
						sap.ui.core.Popup.Dock.LeftTop, oButtonAddSkill,
						"1000 100", "none");
						...
						template : new sap.ui.commons.layout.HorizontalLayout(
								"skill2", {
									content : [
											...
											oButtonAddSkill.bindProperty("visible", "displayed"),
									...
									"SkillTemplate", {
										content : [
												new sap.ui.commons.TextView()
													...
													oButtonAddSkill.bindProperty("visible", "displayed"),
												new sap.ui.commons.TextView({text: "MaxCount: "}).bindProperty("visible", "displayed"), 
												oDropDownBoxProduct
	...
	var dropdownboxproductdata = {
		...
		oListBoxProduct.setMaxWidth("200px");
		oListBoxProduct.bindAggregation("items", "/selectableItems", oListTemplate);
		...
		var shell = new sap.ui.ux3.Shell({
			...
			worksetItemSelected : function(oEvent) {
				...
				case "template":
					...
					shell.setContent(oTemplateTable);
					break;	
